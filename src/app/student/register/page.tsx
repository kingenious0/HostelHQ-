...
export const facultyPrograms: Record<string, string[]> = {
  'Faculty of Technical Education (FTE)': [
    ...
    'B.Sc. Wood Science & Technology Education',
    'Diploma in Technical Education',
  ],
  'Faculty of Vocational Education (FVE)': [
    'B.Sc. Catering & Hospitality Education',
    'B.Sc. Fashion & Textiles Design Education',
