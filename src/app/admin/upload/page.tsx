...
export default function AdminUploadPage() {
    ...
    const handleSubmit = async () => {
        if (!currentUser) {
            toast({ title: 'Not authenticated', description: 'Please log in as an admin to submit.', variant: 'destructive' });
            return;
        }

        if (userRole !== 'admin') {
            toast({ title: 'Access Denied', description: 'You must be an admin to create hostels.', variant: 'destructive' });
            return;
        }
            ...
            <div className="flex flex-col min-h-screen">
                ...
                <main className="flex-1 flex items-center justify-center py-12 px-4 bg-gray-50/50">
                     <Alert variant="destructive" className="max-w-lg">
                        ...
                        <AlertDescription>
                            You must be logged in as an Admin to access this page. Please use the menu in the top right to log in.
                        </AlertDescription>
                    </Alert>
                </main>
            </div>
                            ...
                            {step === 1 && (
                                <div className="space-y-4">
                                    <Alert>
                                        ...
                                        <AlertTitle>Admin Privilege</AlertTitle>
                                        <AlertDescription>
                                            Hostels created by admins are automatically approved and published immediately.
                                        </AlertDescription>
                                    </Alert>
                             ...
                             {step === 5 && (
                                <div className="space-y-4 text-center">
                                    ...
                                    <Alert>
                                        ...
                                        <AlertTitle>Admin Privilege</AlertTitle>
                                        <AlertDescription>
                                            This hostel will be published immediately without approval since you are an admin.
                                        </AlertDescription>
                                    </Alert>
                                </div>
                            )}
